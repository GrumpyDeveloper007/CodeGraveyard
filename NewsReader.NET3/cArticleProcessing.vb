...
Friend Class cArticleProcessing
    ...
    Public ReadOnly Property TotalArticles() As Long
        Get
    ...
    Private Function GetArticleIndex(ByRef psubject As String, ByRef pLeftBracketPos As Integer, ByRef pRightBracketPos As Integer, ByRef pArticleNumber As Long, ByRef pTotalArticles As Integer, ByRef pAlternateBrackets As Boolean) As Boolean
