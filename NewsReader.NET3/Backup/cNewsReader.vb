...
Friend Class cNewsReader
	...
	Public Event ProcessArticle(ByRef pArticleNumber As Integer, ByRef psubject As String, ByRef pLineCount As Integer, ByRef pPostDate As Date, ByRef pGroupID As Integer, ByRef pLinesExpected As Integer)
	Public Event ProcessMissingArticle(ByRef pArticleNumber As Integer, ByRef pGroupID As Integer)
	
	Public Event AddUpdateGroup(ByRef pName As String, ByRef pLowArticle As Double, ByRef pHighArticle As Double, ByRef pPostability As String)
	...
	Public Event GetLastArticleForGroup(ByRef pLastArticleID As Integer, ByRef pGroupID As Integer, ByRef pServerID As Integer)
	
	Public Event GetNextMissingArticle(ByRef pArticleID As Integer, ByRef pGroupID As Integer, ByRef pArticleNumber As Integer)
	...
	Public m_LastArticleIndex As Integer
	Public m_TotalArticles As Integer
	Public m_LastFileSubject As String
	Public m_GroupName As String
	Public m_ArticleNumber As Integer
	...
	Private m_LastArticleID As Integer
	Private m_GetMissingArticles As Boolean
	Private m_MissingArticleID As Integer
	...
	'newsgroup
	Dim ArticleCount1 As Integer 'estimated number of articles in selected newsgroup
	Dim FirstArticle1 As Integer 'first article in selected newsgroup
	Dim LastArticle1 As Integer 'last article in selected newsgroup
	...
	Public Sub SetWinsock(ByRef pWinsock As Winsock)
		clsWinsock = pWinsock
	End Sub
	...
	Private Sub clsWinsock_DataArrival(ByVal bytesTotal As Integer)
					...
					Case TNNTPState.NNTP_STAT_SELECTING
						...
						If rcv <> "" Then
							...
							If SplitLine(0) = CStr(TNNTPRc.NNTP_RC_GROUPSELECTED) Then
								...
								State1 = TNNTPState.NNTP_STAT_CONNECTED
								ArticleCount1 = CInt(SplitLine(1))
								FirstArticle1 = CInt(SplitLine(2))
								LastArticle1 = CInt(SplitLine(3))
	...
	Private Sub clsWinsock_Error(ByVal Number As Short, ByRef Description As String, ByVal Scode As Integer, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Integer, ByRef CancelDisplay As Boolean)
	...
	Public Sub DownloadArticle(ByRef pArticleNumber As Integer)
	...
	Public Function GetXover() As Boolean
		Dim FirstArticle As Integer
		Dim GroupID As Integer
		Dim ArticleNumber As Integer
		Dim GroupFirstArticle As Integer
	...
	Public Sub Connect()
		If m_ConnectionRetrys < FRMOptions.ConnectionAttempts Or FRMOptions.ConnectionAttempts = 0 Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object clsWinsock.Close. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			clsWinsock.Close()
			
			If m_GetMissingArticles = False Then
				Username1 = FRMOptions.Username
				Password1 = FRMOptions.Password
				'UPGRADE_WARNING: Couldn't resolve default property of object clsWinsock.RemoteHost. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object clsWinsock.RemotePort. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			clsWinsock.RemotePort = 119 '9000 ' 7000, 8000, or 9000
			'UPGRADE_WARNING: Couldn't resolve default property of object clsWinsock.Connect. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			clsWinsock.Connect()
		Else
			m_AutoAction = AutoActionENUM.None
			RaiseEvent LogEvent("Connection retry Limit reached")
			MDIMain.LBLProgress(m_Index).Text = "Connection retry Limit reached"
		End If
	End Sub
...
dateError: 
	...
	Private Sub SendData(ByRef pIndex As Short, ByRef pData As String)
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object clsWinsock.SendData. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					...
					If skipline = False Then
						...
						If Tab2 <> 0 Then
							...
							If Tab4 <> 0 Then
								...
								If Tab8 <> 0 Then
									m_Article.ArticleNumber = CInt(Mid(m_rxBuffer, 1, TabPosition - 1))
	...
	Private Sub ProcessGroupList()
		...
		MDIMain.LBLProgress(0).Text = CStr(m_LinesProcessed)
...
dbUpdateError: 
	...
	Private Sub ProcessArticleBody()
		...
		Dim yEncCRCFromDownload As Integer
