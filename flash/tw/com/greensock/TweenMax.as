package com.greensock
{
   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public static function ^e(param1:Array, param2:Number, param3:Object, param4:Object, param5:Number = 0, param6:Function = null, param7:Array = null) : Array
      {
         param4.startAt = param3;
         if(param3.immediateRender)
         {
         ...
         return _M(param1,param2,param4,param5,param6,param7);
      }
      ...
      public static function 0L(param1:Boolean = false, param2:Boolean = true, param3:Boolean = true) : void
      {
         var _loc5_:* = false;
      ...
      public static function allFrom(param1:Array, param2:Number, param3:Object, param4:Number = 0, param5:Function = null, param6:Array = null) : Array
      {
         ...
         return _M(param1,param2,param3,param4,param5,param6);
      }
      ...
      public static function _M(param1:Array, param2:Number, param3:Object, param4:Number = 0, param5:Function = null, param6:Array = null) : Array
      {
         var i:int = 0;
      ...
      public function set timeScale(param1:Number) : void
      {
         ...
         var _loc2_:Number = (_pauseTime) || _pauseTime == 0?_pauseTime:this.timeline.cachedTotalTime;
      ...
      override public function get totalDuration() : Number
      {
         ...
         {
            this.cachedTotalDuration = _repeat == -1?9.99999999999E11:this.cachedDuration * (_repeat + 1) + _repeatDelay * _repeat;
