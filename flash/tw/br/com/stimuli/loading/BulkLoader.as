package br.com.stimuli.loading
{
   ...
   public class BulkLoader extends EventDispatcher
   {
      ...
      public static const f:String = "$Id$";
      ...
      public static function substituteURLString(param1:String, param2:Object) : String
      {
         ...
         var _loc3_:RegExp = new RegExp("(?P<var_name>\\{\\s*[^\\}]*\\})","g");
         ...
         while((Boolean(_loc4_)) && (Boolean(_loc4_.var_name)))
         {
            if(_loc4_.var_name)
            {
               ...
               _loc5_ = _loc5_.replace("}","");
               _loc5_ = _loc5_.replace(new RegExp("\\s*","g"),"");
            }
            _loc6_.push({
               "start":_loc4_.index,
      ...
      public function add(param1:*, param2:Object = null) : LoadingItem
      {
         ...
         else
         {
            ...
            _loc3_ = this.get(param2[ID]);
            if(_loc3_)
            {
               this.S("Add received an already added id: " + param2[ID] + ", not adding a new item");
               return _loc3_;
            }
            if(param2["type"])
            {
               ...
               {
                  this.S("add received an unknown type:",_loc4_,"and will cast it to text",LOG_WARNINGS);
               }
            }
            if(!_loc4_)
            {
            ...
            if(!param2["id"] && (this._allowsAutoIDFromFileName))
            {
               ...
               this.S("Adding automatic id from file name for item:",_loc3_,"( id= " + param2["id"] + " )");
            }
            _loc5_ = _loc3_._parseOptions(param2);
            for each(_loc6_ in _loc5_)
            {
               this.S(_loc6_,LOG_WARNINGS);
            }
            this.S("Added",_loc3_,LOG_VERBOSE);
      ...
      public function _loadNext(param1:LoadingItem = null) : Boolean
      {
         ...
         var _loc2_:* = false;
         var param1:LoadingItem = param1 || this._getNextItemToLoad();
         if(param1)
         {
            _loc2_ = true;
            this._isRunning = true;
            if(this._canOpenConnectioForItem(param1))
            {
               ...
               _loc3_.push(param1);
               param1.load();
               this.S("Will load item:",param1,LOG_INFO);
            }
      ...
      public function _onItemComplete(param1:Event) : void
      {
         ...
         this._removeFromConnections(_loc2_);
         this.S("Loaded ",_loc2_,LOG_INFO);
         this.S("Items to load",this.getNotLoadedItems(),LOG_VERBOSE);
         _loc2_.cleanListeners();
      ...
      public function _removeFromItems(param1:LoadingItem) : Boolean
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            this.S("Removing " + param1,LOG_VERBOSE);
      ...
      public function _onItemError(param1:ErrorEvent) : void
      {
         var _loc2_:LoadingItem = param1.target as LoadingItem;
         this._removeFromConnections(_loc2_);
         this.S("After " + _loc2_.numTries + " I am giving up on " + _loc2_.url.url,LOG_ERRORS);
         this.S("Error loading",_loc2_,param1.text,LOG_ERRORS);
         this._loadNext();
      ...
      {
         var _loc2_:LoadingItem = param1.target as LoadingItem;
         this.S("Started loading",_loc2_,LOG_INFO);
         dispatchEvent(param1);
      }
      ...
      public function _getContentAsType(param1:*, param2:Class, param3:Boolean = false) : *
      {
         ...
         else
         {
            ...
            {
               S("Failed to get content with url: \'" + key + "\'as type:",type,LOG_ERRORS);
            }
            return null;
         }
      }
      ...
      public function getBitmapData(param1:*, param2:Boolean = false) : BitmapData
      {
         ...
         {
            S("Failed to get bitmapData with url:",key,LOG_ERRORS);
         }
         return null;
      }
      ...
      public function getSerializedData(param1:*, param2:Boolean = false, param3:Function = null) : *
      {
         ...
         {
            S("Failed to parse key:",key,"with encodingFunction:" + encodingFunction,LOG_ERRORS);
         }
         return null;
      }
      ...
      public function getStats() : String
      {
         ...
         this.S(statsString,LOG_VERBOSE);
         return statsString;
      }
      
      public function S(... rest) : void
      {
         var _loc2_:int = isNaN(rest[rest.length - 1])?3:int(rest.pop());
      ...
      public function remove(param1:*, param2:Boolean = false) : Boolean
      {
         ...
         {
            S("Error while removing item from key:" + key,e.getStackTrace(),LOG_ERRORS);
         }
         return false;
      }
      ...
      public function pause(param1:*, param2:Boolean = false) : Boolean
      {
         ...
         this.S("STOPPED ITEM:",_loc3_,LOG_INFO);
      ...
      public function pauseAll() : void
      {
         ...
         this._isRunning = false;
         this._isPaused = true;
         this.S("Stopping all items",LOG_INFO);
      }
      ...
      {
         this.S("Resuming all items",LOG_VERBOSE);
