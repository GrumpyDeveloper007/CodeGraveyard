...
Private vValidateCancel As Boolean
'Default Property Values:
Const m_def_TabEnter = 0
Const m_def_BackStyle = 0
Const m_def_ValidateCancel = False
'Property Variables:
...
'    Dim a As Boolean
'    Cancel = vValidateCancel
'    Text1.Text = Text1.Text & Cancel
'End Sub
...
'    Call PropBag.WriteProperty("OLEDropMode", Text1.OLEDropMode, 0)
    ...
    Call PropBag.WriteProperty("ValidateCancel", vValidateCancel, m_def_ValidateCancel)
End Sub
...
Public Property Let ValidateCancel(pValidateCancel As Boolean)
    vValidateCancel = pValidateCancel
End Property

Public Property Get ValidateCancel() As Boolean
    ValidateCancel = vValidateCancel
End Property
