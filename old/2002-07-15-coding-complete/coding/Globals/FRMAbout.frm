...
Private Sub Form_Load()
    ...
    If (Me.Top = 0) Then
        If ((MDIMain.ScaleHeight - Me.Height) / 2 > 0) Then
            Me.Top = (MDIMain.ScaleHeight - Me.Height) / 2
        End If
        If ((MDIMain.ScaleWidth - Me.Width) / 2 > 0) Then
            Me.Left = (MDIMain.ScaleWidth - Me.Width) / 2
        End If
    End If
    Me.LBLProgramName.Caption = cProjectName
    Me.Caption = "About " & cProjectName
    Me.LBLLicencedTo.Caption = "Licensed  to " & vLicencedTo
