...
Private Sub TXTPassword_KeyPress(KeyAscii As Integer)
    ...
    If (KeyAscii = 13) Then
        If (OpenRecordset(rstemp, "SELECT * FROM [user] WHERE [name]=" & cTextField & Trim$(TXTUserName.Text) & cTextField, dbOpenSnapshot) = True) Then
...
Private Sub TXTUserName_KeyPress(KeyAscii As Integer)
    ...
    If (KeyAscii = 13) Then
        If (OpenRecordset(rstemp, "SELECT * FROM [user] WHERE [name]=" & cTextField & Trim$(TXTUserName.Text) & cTextField, dbOpenSnapshot) = True) Then
            If (rstemp.EOF = False) Then
                If (Len(Trim$(rstemp!Password & "")) > 0) Then
