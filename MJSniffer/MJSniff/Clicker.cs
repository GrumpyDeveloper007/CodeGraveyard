...
namespace MJsniffer
{
    class Clicker
    {
        ...
        public int OriginY = 103;
        public int DownDelayUpClick = 100;

        public void SetAndClickWithOrigin(int x, int y, int pause)
        {
            SetAndClick(OriginX + x, OriginY + y, pause);
        }

        public void SetAndClick(int x, int y, int pause)
        {
        ...
        public void HeroSpiritTab()
        {
            ...
            SetAndClick(OriginX + 291, OriginY + 198, DownDelayUpClick); // reset tab
        }

        public void EnhanceTab()
        {
            SetAndClick(OriginX + 363, OriginY + 204, DownDelayUpClick);
        }

        public void SelectItemToEnhance(int spiritSelectedY)
        {
            System.Threading.Thread.Sleep(200);
            SetAndClick(OriginX + 203, OriginY + spiritSelectedY, DownDelayUpClick);
        }

        public void AutoAdd()
        {
            System.Threading.Thread.Sleep(100);
            SetAndClick(OriginX + 362, OriginY + 460, DownDelayUpClick);
        }

        public void ClickFirst8EnhanceBoxes()
        {
            System.Threading.Thread.Sleep(100);
            SetAndClick(OriginX + 555, OriginY + 255, DownDelayUpClick);
            SetAndClick(OriginX + 555, OriginY + 255, DownDelayUpClick);

            SetAndClick(OriginX + 596, OriginY + 255, DownDelayUpClick);
            SetAndClick(OriginX + 596, OriginY + 255, DownDelayUpClick);

            SetAndClick(OriginX + 641, OriginY + 255, DownDelayUpClick);
            SetAndClick(OriginX + 641, OriginY + 255, DownDelayUpClick);

            SetAndClick(OriginX + 682, OriginY + 255, DownDelayUpClick);
            SetAndClick(OriginX + 682, OriginY + 255, DownDelayUpClick);

            SetAndClick(OriginX + 724, OriginY + 255, DownDelayUpClick);
            SetAndClick(OriginX + 724, OriginY + 255, DownDelayUpClick);

            // 2nd row
            SetAndClick(OriginX + 555, OriginY + 299, DownDelayUpClick);
            SetAndClick(OriginX + 555, OriginY + 299, DownDelayUpClick);

            SetAndClick(OriginX + 596, OriginY + 299, DownDelayUpClick);
            SetAndClick(OriginX + 596, OriginY + 299, DownDelayUpClick);

            SetAndClick(OriginX + 641, OriginY + 299, DownDelayUpClick);
            SetAndClick(OriginX + 641, OriginY + 299, DownDelayUpClick);
        }
        ...
        public void Enhance()
        {
            ...
            SetAndClick(OriginX + 464, OriginY + 461, DownDelayUpClick);
        }

        public void OkToEnhanceBluePurple()
        {
            System.Threading.Thread.Sleep(300);
            SetAndClick(OriginX + 374, OriginY + 353, DownDelayUpClick); // ok to enchance blue
        }

        public void OkToEnhanceBlue()
        {
            //436:351
            SetAndClick(OriginX + 436, OriginY + 351, DownDelayUpClick); // ok to enchance blue
        }
